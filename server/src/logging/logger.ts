...
import { LogData, LogLevel } from './types/log.type';
import Logger, { LoggerBaseKey } from './types/logger.type';
...
export default class LoggerService implements Logger {
  ...
  public constructor(
    ...
    this.organization = configService.get<string>('ORGANIZATION') ?? 'org';
    this.context = configService.get<string>('CONTEXT') ?? 'ctx';
